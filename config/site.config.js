...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'toby@tianchen.onmicrosoft.com',
  ...
  email: 'mailto:tianchenzhong@gmail.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/tobiaschung/onedrive-vercel-index',
    },
    {
      name: 'Website',
      link: 'https://www.tobychung.com',
    },
  ],
